...
var RecoveryPageRoutingModule = /** @class */ (function () {
    function RecoveryPageRoutingModule() {
    }
...
var RecoveryPage = /** @class */ (function () {
    function RecoveryPage(router, menu, formBuilder, authService, alertCtrl) {
        this.router = router;
        this.menu = menu;
    ...
    RecoveryPage.prototype.ngOnInit = function () {
    };
    RecoveryPage.prototype.ionViewWillEnter = function () {
        this.menu.enable(false);
    };
    RecoveryPage.prototype.solicitar = function () {
        var _this = this;
        this.loading = true;
    ...
    RecoveryPage.prototype.registrar = function () {
        ...
        this.authService.doRecovery(this.recovery).subscribe(function (res) {
            _this.loading = false;
            _this.showOk();
        }, function (error) { _this.loading = false; });
    };
    RecoveryPage.prototype.showRequestOk = function () {
    ...
    RecoveryPage.prototype.showOk = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    RecoveryPage.prototype.getValid = function () {
        return !(this.formGroup.valid && this.getSenhas());
    };
    RecoveryPage.prototype.getSenhas = function () {
        return this.formGroup.get('senha').value == this.formGroup.get('senhaR').value;
    };
    RecoveryPage.ctorParameters = function () { return [
...
//# sourceMappingURL=recovery-recovery-module-es5.js.map