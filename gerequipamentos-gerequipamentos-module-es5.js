...
var ItemUpdateComponent = /** @class */ (function () {
    function ItemUpdateComponent(modalCtrl, formBuilder, itemService, alertController, storage, paginaService, toast) {
    ...
    ItemUpdateComponent.prototype.ngOnInit = function () {
        ...
        this.requestUpdate = false;
        this.loading = true;
        var id = this.itemService.getStaticID();
        var type = this.itemService.getStaticType().toString();
        ...
        this.itemService.findById(id, type)
            ...
            _this.formItem.get('valor').setValue(valor);
            _this.formItem.get('peso').setValue(peso);
            _this.formItem.get('urlImg').setValue(imgURL);
            _this.formItem.get('idTipoRPG').setValue(_this.getCurrentType(tipoRPG));
            if (isPrivate == false) {
                _this.formItem.get('isPrivate').setValue(false);
            }
            else {
                _this.formItem.get('isPrivate').setValue(true);
            }
            switch (tipoItem) {
                case 'ATAQUE':
                    var bonusAtaque = res.bonusAtaque, critico = res.critico, dano = res.dano, distancia = res.distancia, tipoAtaque = res.tipoAtaque;
                    _this.formArma.get('danoBonus').setValue(bonusAtaque);
                    _this.formArma.get('critico').setValue(critico);
                    _this.formArma.get('dano').setValue(dano);
                    _this.formArma.get('distancia').setValue(distancia);
                    _this.formArma.get('idTipoArma').setValue(_this.getCurrentAtaque(tipoAtaque));
                    break;
                case 'DEFESA':
                    var bonusDefesa = res.bonusDefesa, bonusDestreza = res.bonusDestreza, penalidade = res.penalidade, tipoDefesa = res.tipoDefesa;
                    _this.formDefesa.get('defesaBonus').setValue(bonusDefesa);
                    _this.formDefesa.get('destrezaBonus').setValue(bonusDestreza);
                    _this.formDefesa.get('penalidade').setValue(penalidade);
                    _this.formDefesa.get('idTipoDefesa').setValue(_this.getCurrentDefesa(tipoDefesa));
                    break;
                case 'UTILIZAVEL':
                    var efeito = res.efeito, tipoUtilizavel = res.tipoUtilizavel;
                    _this.formUti.get('efeito').setValue(efeito);
                    _this.formUti.get('idTipoUtilizavel').setValue(_this.getCurrentUtilizavel(tipoUtilizavel));
            }
            _this.loading = false;
        }, function (error) {
            console.log(error);
    ...
    ItemUpdateComponent.prototype.next = function (form) {
    ...
    ItemUpdateComponent.prototype.salvarArma = function () {
        ...
        this.itemService.updateAtaque(obj)
            ...
            _this.callToast('success', 'Atualizado com sucesso!', 'Item de ataque atualizado');
        }, function (error) { });
    };
    ItemUpdateComponent.prototype.salvarDefesa = function () {
        var _this = this;
        var obj = {
            id: this.itemService.getStaticID(),
            nome: this.formItem.get('nome').value,
        ...
        this.itemService.updateDefesa(obj)
            ...
            _this.loading = false;
            _this.requestUpdate = true;
            _this.callToast('success', 'Atualizado com sucesso!', 'Item de defesa atualizado');
        }, function (error) { });
    };
    ItemUpdateComponent.prototype.salvarUtilizavel = function () {
        var _this = this;
        var obj = {
            id: this.itemService.getStaticID(),
            nome: this.formItem.get('nome').value,
        ...
        this.itemService.updateUtilizavel(obj)
            ...
            _this.loading = false;
            _this.requestUpdate = true;
            _this.callToast('success', 'Atualizado com sucesso!', 'Item utilizável atualizado');
        }, function (error) { });
    };
    ItemUpdateComponent.prototype.copyToClipboard = function (value) {
    ...
    ItemUpdateComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.clear();
        this.toast.add({
            severity: severity,
            summary: summary,
    ...
    ItemUpdateComponent.prototype.close = function () {
        this.modalCtrl.dismiss(this.requestUpdate, null, 'princi');
    };
    ItemUpdateComponent.prototype.getCurrentType = function (tipo) {
        switch (tipo) {
            case "MEDIEVAL_RPG":
                return 0;
                break;
    ...
    ItemUpdateComponent.prototype.getCurrentAtaque = function (tipo) {
        switch (tipo) {
            case "CORTE":
                return 0;
                break;
    ...
    ItemUpdateComponent.prototype.getCurrentDefesa = function (tipo) {
        switch (tipo) {
            case "CABECA":
                return 0;
                break;
    ...
    ItemUpdateComponent.prototype.getCurrentUtilizavel = function (tipo) {
        switch (tipo) {
            case "CONSUMIVEL":
                return 0;
                break;
    ...
    ItemUpdateComponent.ctorParameters = function () { return [
...
var ItemUpdateModule = /** @class */ (function () {
    function ItemUpdateModule() {
    }
...
var GerequipamentosPageModule = /** @class */ (function () {
    function GerequipamentosPageModule() {
    }
    ...
    return GerequipamentosPageModule;
}());
...
var GerequipamentosPage = /** @class */ (function () {
    function GerequipamentosPage(modalCtrl, itemService, alertController, paginaService) {
        this.modalCtrl = modalCtrl;
        this.itemService = itemService;
        this.alertController = alertController;
        this.paginaService = paginaService;
    ...
    GerequipamentosPage.prototype.ngOnInit = function () {
    };
    GerequipamentosPage.prototype.getNotification = function (evt) {
        if (this.paginaAtual != evt) {
            this.paginaAtual = evt;
            this.consultar();
        }
    };
    GerequipamentosPage.prototype.consultar = function () {
        var p;
    ...
    GerequipamentosPage.prototype.listar = function () {
        this.listDisplay = true;
        this.display = false;
    };
    GerequipamentosPage.prototype.destroyList = function () {
        this.paginaAtual = 0;
        this.listDisplay = false;
    };
    GerequipamentosPage.prototype.novo = function () {
        this.listDisplay = false;
        if (this.display) {
            this.display = false;
        }
    ...
    GerequipamentosPage.prototype.selectedObj = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    GerequipamentosPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
//# sourceMappingURL=gerequipamentos-gerequipamentos-module-es5.js.map