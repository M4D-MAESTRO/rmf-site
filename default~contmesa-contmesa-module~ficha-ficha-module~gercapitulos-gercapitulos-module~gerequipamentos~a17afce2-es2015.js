...
let ListasComponent = class ListasComponent {
    constructor(alertController, modalCtrl) {
    ...
    remov(stringRemovida) {
        this.strings.forEach((element, index, arr) => {
                ...
                buttons: [
                    {
                        ...
                        handler: data => {
                            let a = [];
                            a.push();
                            let t = this.strings.push(data.palavra);
                        }
                    }
                ]
            });
...
let ListasModule = class ListasModule {
};
...
//# sourceMappingURL=default~contmesa-contmesa-module~ficha-ficha-module~gercapitulos-gercapitulos-module~gerequipamentos~a17afce2-es2015.js.map