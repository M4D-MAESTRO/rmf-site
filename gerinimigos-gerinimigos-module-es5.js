...
var UpdateNpcComponent = /** @class */ (function () {
    function UpdateNpcComponent(modalCtrl, formBuilder, fmService, npcService, alertController, fichaService, storage, modalController) {
    ...
    UpdateNpcComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.requestUpdate = false;
        this.loading = true;
        var id = this.npcService.getStaticID();
        this.npcService.findById(id)
            .subscribe(function (npc) {
            //console.log(npc);
            var idNpc = npc.idNpc, historia = npc.historia, objetivos = npc.objetivos, interesses = npc.interesses, isPrivate = npc.isPrivate, tipoNpc = npc.tipoNpc, ficha = npc.ficha;
            var dinheiro = ficha.inventario.dinheiro;
            _this.formNpc.get('historia').setValue(historia);
            _this.formNpc.get('tipoNpc').setValue(_this.getCurrentType(tipoNpc));
            _this.formNpc.get('valorInventario').setValue(dinheiro);
            if (isPrivate == false) {
                _this.formNpc.get('isPrivate').setValue(false);
            }
            else {
                _this.formNpc.get('isPrivate').setValue(true);
            }
            _this.objetivos = objetivos;
            _this.interesses = interesses;
            _this.newNpc = {
                historia: historia,
    ...
    UpdateNpcComponent.prototype.ionViewDidLoad = function () {
    };
    UpdateNpcComponent.prototype.salvar = function () {
        var _this = this;
        this.loading = true;
    ...
    UpdateNpcComponent.prototype.getCurrentType = function (tipoNpc) {
        switch (tipoNpc) {
            case "ALIADO":
                return 0;
                break;
    ...
    UpdateNpcComponent.prototype.updateType = function (evt) {
        var tipo = evt.detail.value;
        this.formNpc.get('tipoNpc').setValue(tipo);
    };
    UpdateNpcComponent.prototype.showFicha = function () {
    ...
    UpdateNpcComponent.prototype.consultar = function () {
        var _this = this;
        this.loading = true;
        this.display = false;
        this.achado = false;
    ...
    UpdateNpcComponent.prototype.inserirObjetivo = function () {
    ...
    UpdateNpcComponent.prototype.inserirInteresse = function () {
    ...
    UpdateNpcComponent.prototype.presentError = function (texto) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UpdateNpcComponent.prototype.img = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UpdateNpcComponent.prototype.close = function () {
        this.modalCtrl.dismiss(this.requestUpdate, null, 'princi');
    };
    UpdateNpcComponent.ctorParameters = function () { return [
...
var UpdateNpcModule = /** @class */ (function () {
    function UpdateNpcModule() {
    }
...
var GerinimigosPageModule = /** @class */ (function () {
    function GerinimigosPageModule() {
    }
...
var GerinimigosPage = /** @class */ (function () {
    function GerinimigosPage(router, menu, paginaService, itemService, npcService, toast, modalCtrl) {
        this.router = router;
        this.menu = menu;
    ...
    GerinimigosPage.prototype.requestRefresh = function (evt) {
        console.log('Entrou no request');
        this.doRefresh.next(true);
    };
    GerinimigosPage.prototype.ngOnInit = function () {
    };
    GerinimigosPage.prototype.ionViewWillEnter = function () {
    };
    GerinimigosPage.prototype.nav = function () {
        this.router.navigateByUrl('novinimigo');
    };
    GerinimigosPage.prototype.novo = function () {
        this.listDisplay = false;
        if (this.display) {
            this.display = false;
        }
    ...
    GerinimigosPage.prototype.getNotification = function (evt) {
        if (this.paginaAtual != evt) {
            this.paginaAtual = evt;
            this.consultar();
        }
    };
    GerinimigosPage.prototype.consultar = function () {
        this.toast.clear();
        var p;
    ...
    GerinimigosPage.prototype.listar = function () {
        this.listDisplay = true;
        this.display = false;
    };
    GerinimigosPage.prototype.destroyList = function () {
        this.listDisplay = false;
    };
    GerinimigosPage.prototype.callToast = function (severity, summary, detail) {
        this.toast.add({
            severity: severity,
            summary: summary,
            detail: detail
    ...
    GerinimigosPage.prototype.selectedObj = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            var data = res.data;
                            if (data == true) {
                                var p = _this.npcService.findPageByCriador(_this.paginaAtual.toString());
    ...
    GerinimigosPage.prototype.close = function () {
        this.listDisplay = false;
        this.display = false;
    };
    GerinimigosPage.ctorParameters = function () { return [
...
//# sourceMappingURL=gerinimigos-gerinimigos-module-es5.js.map