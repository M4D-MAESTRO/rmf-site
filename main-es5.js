...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        ...
        var N = _config_api_config__WEBPACK_IMPORTED_MODULE_4__["API_CONFIG"].baseUrl.length;
        var reqToApi = req.url.substring(0, N) == _config_api_config__WEBPACK_IMPORTED_MODULE_4__["API_CONFIG"].baseUrl;
...
var ErrorInterceptor = /** @class */ (function () {
    function ErrorInterceptor(storage, alertContr) {
        this.storage = storage;
        ...
        return next.handle(req)
            ...
            switch (error.status) {
                case 403:
                    ...
                    break;
                case 401:
                    _this.handle401(error.error);
                    break;
                case 422:
                    _this.handle422(error.error);
                    break;
                case 404:
                    _this.handle404(error.error);
                    break;
                default:
                    _this.handleDefaultError(error.error);
            }
    ...
    ErrorInterceptor.prototype.handle422 = function (e) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ErrorInterceptor.prototype.handleDefaultError = function (e) {
        this.createAlert(e);
    };
...
var StorageService = /** @class */ (function () {
    ...
    StorageService.prototype.getLocalUser = function () {
        var user = localStorage.getItem(_config_storage_keys_config__WEBPACK_IMPORTED_MODULE_2__["STORAGE_KEYS"].localUser);
        if (user == null) {
            return null;
        }
        else {
    ...
    StorageService.prototype.getLocalUserId = function () {
        return this.getLocalUser().id;
    };
    StorageService.prototype.setLocalUserId = function (id) {
