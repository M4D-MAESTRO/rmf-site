...
/***/ "./node_modules/primeng/fesm5/primeng-checkbox.js":
/*!********************************************************!*\
  !*** ./node_modules/primeng/fesm5/primeng-checkbox.js ***!
  \********************************************************/
...
/***/ "./node_modules/primeng/fesm5/primeng-orderlist.js":
/*!*********************************************************!*\
  !*** ./node_modules/primeng/fesm5/primeng-orderlist.js ***!
  \*********************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var primeng_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! primeng/button */ "./node_modules/primeng/fesm5/primeng-button.js");
...
var OrderList = /** @class */ (function () {
    ...
    OrderList.prototype.ngAfterViewChecked = function () {
        if (this.movedUp || this.movedDown) {
            var listItems = primeng_dom__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].find(this.listViewChild.nativeElement, 'li.ui-state-highlight');
            var listItem = void 0;
    ...
    OrderList.prototype.onItemClick = function (event, item, index) {
        ...
        var selectedIndex = primeng_utils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].findIndexInList(item, this.selection);
    ...
    OrderList.prototype.moveUp = function (event) {
        if (this.selection) {
            for (var i = 0; i < this.selection.length; i++) {
                ...
                var selectedItemIndex = primeng_utils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].findIndexInList(selectedItem, this.value);
...
var CriarComponenteComponent = /** @class */ (function () {
    function CriarComponenteComponent(modalCtrl, formBuilder, itemService, alertController, storage) {
    ...
    CriarComponenteComponent.prototype.ngOnInit = function () {
    };
    CriarComponenteComponent.prototype.next = function (form) {
    ...
    CriarComponenteComponent.prototype.salvarArma = function () {
        var _this = this;
        this.loading = true;
        var obj = {
            id: null,
        ...
        this.itemService.insertAtaque(obj)
            ...
            _this.loading = false;
            _this.clearForms();
            _this.presentAdicionar(res.body.id);
        }, function (error) {
            _this.loading = false;
        });
    };
    CriarComponenteComponent.prototype.salvarDefesa = function () {
        var _this = this;
        this.loading = true;
        var obj = {
            id: null,
    ...
    CriarComponenteComponent.prototype.salvarUtilizavel = function () {
        var _this = this;
        this.loading = true;
        var obj = {
            id: null,
    ...
    CriarComponenteComponent.prototype.clearForms = function () {
    ...
    CriarComponenteComponent.prototype.presentAdicionar = function (id) {
    ...
    CriarComponenteComponent.prototype.close = function (id) {
        var _this = this;
        this.modalCtrl.getTop().then(function (value) {
            if (value) {
    ...
    CriarComponenteComponent.prototype.copyToClipboard = function (value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var id;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                id = function (e) {
    ...
    CriarComponenteComponent.ctorParameters = function () { return [
    ...
    return CriarComponenteComponent;
}());
...
var FichaComponent = /** @class */ (function () {
    function FichaComponent(router, menu, formBuilder, alertController, modalCtrl, toast, fichaService, service, firestore) {
        this.router = router;
        this.menu = menu;
        this.formBuilder = formBuilder;
        this.alertController = alertController;
    ...
    FichaComponent.prototype.getFicha = function () {
        var _this = this;
        this.fichaService.findFichaById(this.idFicha)
            .subscribe(function (res) {
            var fm = res.fichaModelo;
            _this.formGroup.get('nome').setValue(fm.nome);
            _this.formGroup.get('classe').setValue(fm.classe);
            _this.formGroup.get('karma').setValue(fm.karmaAtual);
            _this.formGroup.get('nivel').setValue(fm.nivel);
            _this.formGroup.get('pvAtual').setValue(fm.pvAtual);
            _this.formGroup.get('pvTotal').setValue(fm.pvTotal);
            _this.formGroup.get('raca').setValue(fm.raca);
            _this.formGroup.get('tedencia').setValue(fm.tedencia);
            _this.formGroup.get('xpAtual').setValue(fm.xpAtual);
            _this.formGroup.get('xpPra').setValue(fm.xpPra);
            _this.formGroup.get('pmTotal').setValue(fm.pmTotal);
            _this.formGroup.get('pmAtual').setValue(fm.pmAtual);
            _this.formGroup.get('atributos').setValue(fm.atributos);
            _this.formGroup.get('historia').setValue(res.historia);
            _this.formGroup.get('vantagens').setValue(res.vantagens);
            _this.formGroup.get('desvantagens').setValue(res.desvantagens);
            _this.editavel = res.editavel;
            _this.tipRPG = fm.tipoRPG;
            _this.loading = false;
            _this.idInventario = res.inventario.idInventario;
            _this.urlImg = res.urlImg;
        }, function (error) { _this.loading = false; });
    };
    FichaComponent.prototype.setupWebSocket = function () {
        var _this = this;
        try {
    ...
    FichaComponent.prototype.salvar = function () {
        var _this = this;
        this.loading = true;
        var a = [];
        this.formGroup.get('atributos').value.forEach(function (atributo) {
            a.push({
        ...
        if (this.isJogador) {
            this.fichaService.update(ficha)
                .subscribe(function (res) {
                _this.loading = false;
                _this.callToast('success', 'Salvo com sucesso!', 'Sua ficha foi salva/atualizada');
                //this.setupWebSocket();
            }, function (error) { _this.loading = false; });
        }
        else {
    ...
    FichaComponent.prototype.selectAtributo = function (event, atributo) {
        this.selectedAtributo = atributo;
        this.displayDialog = true;
        event.preventDefault();
    };
    FichaComponent.prototype.mudaAba = function (event) {
    };
    FichaComponent.prototype.getAtributos = function () {
        var atributos = this.formGroup.get('atributos').value;
        return atributos;
    };
    FichaComponent.prototype.showDialog = function (titulo, status, opcao) {
        this.display = {
            show: true,
            titulo: titulo,
            status: status
    ...
    FichaComponent.prototype.cancelStatus = function () {
        this.display.show = false;
    };
    FichaComponent.prototype.handleInsercao = function () {
        var adicionado = Number(this.formGroup.get('valorInserido').value);
        switch (this.opcao) {
            case 0: //inserirXP
    ...
    FichaComponent.prototype.inserirXPMantendo = function (adicionado) {
        var xpAtual = Number(this.formGroup.get('xpAtual').value);
        var xpPra = Number(this.formGroup.get('xpPra').value);
        xpAtual += adicionado;
        if (xpAtual > xpPra) {
            for (var i = xpPra; i <= xpAtual; i += 150) {
                xpAtual -= i;
                xpPra += 150;
                this.levelUp();
            }
    ...
    FichaComponent.prototype.inserirXPRemovendo = function (adicionado) {
        var xpAtual = Number(this.formGroup.get('xpAtual').value);
        var xpPra = Number(this.formGroup.get('xpPra').value);
        xpAtual += adicionado;
        if (xpAtual >= xpPra) {
    ...
    FichaComponent.prototype.inserirKarma = function (adicionado) {
        var karma = Number(this.formGroup.get('karma').value);
        karma += adicionado;
        if (karma >= 100) {
            karma = 100;
        }
    ...
    FichaComponent.prototype.removerKarma = function (adicionado) {
        var karma = Number(this.formGroup.get('karma').value);
        karma -= adicionado;
        if (karma <= 0) {
            karma = 0;
    ...
    FichaComponent.prototype.inserirPV = function (adicionado) {
        var pvAtual = Number(this.formGroup.get('pvAtual').value) + adicionado;
        var pvTotal = Number(this.formGroup.get('pvTotal').value);
        if (pvAtual >= pvTotal) {
            pvAtual = pvTotal;
        }
        this.formGroup.get('pvAtual').setValue(pvAtual);
    };
    FichaComponent.prototype.inserirPM = function (adicionado) {
        var pmAtual = Number(this.formGroup.get('pmAtual').value) + adicionado;
        var pmTotal = Number(this.formGroup.get('pmTotal').value);
        if (pmAtual >= pmTotal) {
            pmAtual = pmTotal;
        }
        this.formGroup.get('pmAtual').setValue(pmAtual);
    };
    FichaComponent.prototype.removerPV = function (adicionado) {
        var pvAtual = Number(this.formGroup.get('pvAtual').value) - adicionado;
        if (pvAtual <= 0) {
            pvAtual = 0;
        }
    ...
    FichaComponent.prototype.removerPM = function (adicionado) {
        var pmAtual = Number(this.formGroup.get('pmAtual').value) - adicionado;
        if (pmAtual <= 0) {
            pmAtual = 0;
        }
    ...
    FichaComponent.prototype.levelUp = function () {
        this.formGroup.get('nivel').setValue(Number(this.formGroup.get('nivel').value) + 1);
    };
    FichaComponent.prototype.getColor = function (aba) {
    ...
    FichaComponent.prototype.openModal = function (atributo, event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var flag, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    FichaComponent.prototype.openLista = function (lista) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    FichaComponent.prototype.callToast = function (severity, summary, detail) {
        this.toast.add({
            severity: severity,
            summary: summary,
            detail: detail
    ...
    FichaComponent.prototype.atributoNivel = function (atributo, opcao) {
        if (opcao) {
            atributo.nivel++;
        }
        else {
    ...
    FichaComponent.prototype.atributoBonus = function (atributo, opcao) {
        if (opcao) {
            atributo.bonus++;
        }
        else {
    ...
    FichaComponent.prototype.close = function () {
        this.modalCtrl.dismiss();
    };
    FichaComponent.prototype.canUpdate = function () {
    ...
    FichaComponent.prototype.openImg = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onWillDismiss()
                            ...
                            if (data.data != '') {
                                if (_this.isJogador) {
                                    _this.fichaService.updateImg(_this.idFicha, data.data)
                                        .subscribe(function (res) {
                                        _this.urlImg = data.data;
                                    }, function (error) {
                                        console.log(error);
                                    });
                                }
                                else {
                                    _this.fichaService.updateImgNpc(_this.idNpc, _this.idMesa, data.data)
                                        .subscribe(function (res) {
                                        _this.urlImg = data.data;
                                    }, function (error) {
                                        console.log(error);
...
/* harmony import */ var primeng_checkbox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! primeng/checkbox */ "./node_modules/primeng/fesm5/primeng-checkbox.js");
...
/* harmony import */ var primeng_orderlist__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! primeng/orderlist */ "./node_modules/primeng/fesm5/primeng-orderlist.js");
/* harmony import */ var primeng_dataview__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! primeng/dataview */ "./node_modules/primeng/fesm5/primeng-dataview.js");
/* harmony import */ var primeng_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! primeng/api */ "./node_modules/primeng/fesm5/primeng-api.js");
/* harmony import */ var primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/inputtextarea */ "./node_modules/primeng/fesm5/primeng-inputtextarea.js");
...
var FichasModule = /** @class */ (function () {
...
var ImagemComponent = /** @class */ (function () {
    function ImagemComponent(modalCtrl, service, toast) {
        this.modalCtrl = modalCtrl;
        this.service = service;
        this.toast = toast;
        this.src = '';
    ...
    ImagemComponent.prototype.ngOnInit = function () {
        var p = this.service.getPromisse();
        if (p) {
            this.src = p;
        }
    };
    ImagemComponent.prototype.close = function () {
        this.modalCtrl.dismiss(this.src);
    };
    ImagemComponent.prototype.getImg = function () {
    ...
    ImagemComponent.prototype.update = function () {
        var p = this.service.getPromisse();
        p.subscribe(function (res) { return console.log(res); });
    };
    ImagemComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
/* harmony import */ var primeng_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! primeng/card */ "./node_modules/primeng/fesm5/primeng-card.js");
...
var ImagemModule = /** @class */ (function () {
    function ImagemModule() {
    }
...
var AtaqueArmasComponent = /** @class */ (function () {
    function AtaqueArmasComponent(modalCtrl, equiparService) {
        this.modalCtrl = modalCtrl;
    ...
    AtaqueArmasComponent.prototype.ngOnInit = function () {
        this.ataque = this.equiparService.ataquesEquipados;
    };
    AtaqueArmasComponent.prototype.show = function (info) {
        if (this.isShow) {
    ...
    AtaqueArmasComponent.prototype.getTipo = function (item) {
        var tipo = "";
        switch (item) {
    ...
    AtaqueArmasComponent.prototype.close = function () {
        this.modalCtrl.dismiss();
    };
    AtaqueArmasComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
var DefesaArmaduraComponent = /** @class */ (function () {
    function DefesaArmaduraComponent(modalCtrl) {
        this.modalCtrl = modalCtrl;
    }
    DefesaArmaduraComponent.prototype.ngOnInit = function () { };
    DefesaArmaduraComponent.prototype.close = function () {
        this.modalCtrl.dismiss();
    };
    DefesaArmaduraComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
    ]; };
    ...
    return DefesaArmaduraComponent;
}());
...
var EspecializacoesComponent = /** @class */ (function () {
    function EspecializacoesComponent(alertController, modalCtrl, especService) {
        this.alertController = alertController;
        this.modalCtrl = modalCtrl;
    ...
    EspecializacoesComponent.prototype.ngOnInit = function () {
    };
    EspecializacoesComponent.prototype.addEspec = function () {
        this.presentAlertPrompt();
    };
    EspecializacoesComponent.prototype.fav = function (especializacao, slide) {
    ...
    EspecializacoesComponent.prototype.remov = function (especializacao) {
        var _this = this;
    ...
    EspecializacoesComponent.prototype.presentAlertPrompt = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EspecializacoesComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
    ...
    return EspecializacoesComponent;
}());
...
var InventarioComponent = /** @class */ (function () {
    function InventarioComponent(modalCtrl, alertController, itemService, equiparService, inventarioService, itensService, toast) {
        this.modalCtrl = modalCtrl;
        this.alertController = alertController;
        this.itemService = itemService;
        this.equiparService = equiparService;
    ...
    InventarioComponent.prototype.updateTable = function () {
    ...
    InventarioComponent.prototype.setList = function (op, botao, botoes) {
    ...
    InventarioComponent.prototype.selecionar = function (item, row) {
    ...
    InventarioComponent.prototype.getPesoTotal = function () {
        var _this = this;
        this.peso = 0;
    ...
    InventarioComponent.prototype.adicionar = function () {
        this.presentAdicionar();
        this.getPesoTotal();
    };
    InventarioComponent.prototype.setTipoitem = function (event) {
        this.selectedItem = event.detail.value;
    };
    InventarioComponent.prototype.presentAdicionar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        if ((data.id != "")) {
                                            _this.inventarioUP = {
                                                dinheiro: _this.inventario.dinheiro,
                                                idItem: data.id,
                                                isRemov: false,
                                                tipoItem: _this.selectedItem
                                            };
                                            if (_this.isJogador) {
                                                _this.inventarioService.update(_this.idInventario, _this.inventarioUP)
                                                    .subscribe(function (res) {
                                                    _this.inventario = res;
                                                    _this.updateTable();
                                                    _this.getPesoTotal();
                                                });
                                            }
                                            else {
                                                _this.inventarioService.updateInMesa(_this.inventarioUP, _this.idInventario, _this.idNpc, _this.tipoNpc, _this.idMesa)
                                                    .subscribe(function (res) {
                                                    _this.inventario = res;
                                                    _this.updateTable();
                                                    _this.getPesoTotal();
    ...
    InventarioComponent.prototype.remover = function () {
        var _this = this;
        this.inventarioUP = {
    ...
    InventarioComponent.prototype.getEnum = function (value) {
        var n = 0;
        switch (value) {
            case 'ATAQUE':
                n = 0;
    ...
    InventarioComponent.prototype.vender = function () {
        var _this = this;
        if (isNaN(this.acrescimoDesconto)) {
            this.acrescimoDesconto = 0;
        }
        var aux = this.inventario.dinheiro + this.itemSelected.valor;
        if (this.isJogador) {
    ...
    InventarioComponent.prototype.presentVender = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    cssClass: 'secondary',
                                    handler: function (data) {
                                        _this.acrescimoDesconto = (-parseFloat(data.valor));
                                        _this.vender();
                                    }
                                },
                                {
    ...
    InventarioComponent.prototype.presentOperation = function (isCreditar) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1, alert_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!isCreditar) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            if (!isNaN(data.valor)) {
                                                var aux = _this.inventario.dinheiro + parseInt(data.valor);
                                                if (_this.isJogador) {
                                                    _this.inventarioService.updateDinheiro(_this.idInventario, aux.toString())
                                                        .subscribe(function (res) {
                                                        _this.inventario = res;
                                                        console.log(res);
                                                    });
                                                    ...
                                                    _this.inventarioService.updateDinheiroInMesa(aux.toString(), _this.idInventario, _this.idNpc, _this.tipoNpc, _this.idMesa)
                                                        .subscribe(function (res) {
                                                        _this.inventario = res;
                                                        console.log(res);
                                                    });
    ...
    InventarioComponent.prototype.presentNumberExcpetion = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    InventarioComponent.prototype.presentUndfinedExcpetion = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    InventarioComponent.prototype.openModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    InventarioComponent.prototype.acao = function () {
    };
    InventarioComponent.prototype.callToast = function () {
        this.toast.add({
            severity: 'warn',
            summary: 'Em breve',
...
var FichaService = /** @class */ (function () {
    function FichaService(http) {
        ...
        this.isJogador = true;
        this.closeBTN = false;
        this.insert = function (dto) {
            return _this.http.post(src_app_config_api_config__WEBPACK_IMPORTED_MODULE_3__["API_CONFIG"].baseUrl + "ficha", dto, {
                responseType: 'json',
            });
        };
    }
    FichaService.prototype.getConfiguration = function () {
        return {
            ficha: this.ficha,
    ...
    FichaService.prototype.setConfiguration = function (ficha, isJogador, idNpc, idMesa, tipoNpc, closeBTN) {
        this.ficha = ficha;
    ...
    FichaService.prototype.resetConfiguration = function () {
        this.ficha = undefined;
        this.isJogador = true;
    ...
    FichaService.prototype.findFichaByMesaAndJogador = function (idUser, idMesa) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idUser', idUser)
            .set('idMesa', idMesa);
    ...
    FichaService.prototype.updateImg = function (idFicha, urlImg) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idFicha', idFicha)
            .set('urlImg', urlImg);
    ...
    FichaService.prototype.updateImgNpc = function (idNpc, idMesa, urlImg) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idNpc', idNpc)
            .set('idMesa', idMesa)
            .set('urlImg', urlImg);
...
//# sourceMappingURL=default~contmesa-contmesa-module~ficha-ficha-module~gerequipamentos-gerequipamentos-module~gerinimig~dc9172e7-es5.js.map