...
/* harmony import */ var primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! primeng/inputtextarea */ "./node_modules/primeng/fesm2015/primeng-inputtextarea.js");
...
/* harmony import */ var primeng_panel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! primeng/panel */ "./node_modules/primeng/fesm2015/primeng-panel.js");
/* harmony import */ var primeng_dropdown__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/dropdown */ "./node_modules/primeng/fesm2015/primeng-dropdown.js");
/* harmony import */ var primeng_message__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! primeng/message */ "./node_modules/primeng/fesm2015/primeng-message.js");
...
let SuportePage = class SuportePage {
    constructor(toast, formBuilder, notify) {
        this.toast = toast;
    ...
    enviar() {
        this.loading = true;
        const motivo = this.formGroup.get('motivo').value;
        const descricao = this.formGroup.get('descricao').value;
        console.log(motivo, descricao);
        this.notify.contact({ motivo, descricao })
            .subscribe(res => {
            this.callToast('success', 'Contato enviado!', 'Agradecemos sua colaboração :D');
            this.loading = false;
        }, error => {
            console.log(error);
            this.loading = false;
