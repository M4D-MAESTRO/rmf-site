...
let HomePage = class HomePage {
    constructor(router, menu, user, storage, plataform, fundoService) {
        this.router = router;
        this.menu = menu;
        this.user = user;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.user.findByEmail(localUser.email)
                .subscribe(res => {
                this.storage.setLocalUserId(res.id);
            });
    ...
    nav(opcao) {
        switch (opcao) {
            case '1':
                this.router.navigateByUrl('germesas');
                break;
            case '2':
                this.router.navigateByUrl('gercriacoes');
                break;
            case '3':
