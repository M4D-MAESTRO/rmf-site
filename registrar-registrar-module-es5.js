...
/* harmony import */ var primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! primeng/inputtextarea */ "./node_modules/primeng/fesm5/primeng-inputtextarea.js");
...
/* harmony import */ var primeng_tabview__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! primeng/tabview */ "./node_modules/primeng/fesm5/primeng-tabview.js");
/* harmony import */ var primeng_panel__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/panel */ "./node_modules/primeng/fesm5/primeng-panel.js");
...
/* harmony import */ var primeng_message__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! primeng/message */ "./node_modules/primeng/fesm5/primeng-message.js");
...
var RegistrarPage = /** @class */ (function () {
    function RegistrarPage(router, menu, formBuilder, userService, alertCtrl) {
        this.router = router;
        this.menu = menu;
    ...
    RegistrarPage.prototype.ngOnInit = function () {
    };
    RegistrarPage.prototype.ionViewWillEnter = function () {
    ...
    RegistrarPage.prototype.registrar = function () {
        ...
        this.userService.insertNew(this.user).subscribe(function (res) {
            _this.loading = false;
            _this.showOk();
        }, function (error) { _this.loading = false; });
    };
    RegistrarPage.prototype.showOk = function () {
                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [
                                {
                                    text: 'OK',
                                    handler: function () { _this.router.navigateByUrl('login'); }
                                }
                            ]
                        })];
                    case 1:
    ...
    RegistrarPage.prototype.getValid = function () {
        return !(this.formGroup.valid && this.getSenhas());
    };
    RegistrarPage.prototype.getSenhas = function () {
        return this.formGroup.get('senha').value == this.formGroup.get('senhaR').value;
    };
    RegistrarPage.ctorParameters = function () { return [
